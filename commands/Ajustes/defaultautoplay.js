...
module.exports = {
  ...
  description: "Cambia el valor del autoplay", //the command description for helpcmd [OPTIONAL]
    ...
    try {
      ...
      return message.reply({
        embeds: [
          ...
          .setTitle(`${client.allEmojis.check_mark} **El Autoplay está __\`${client.settings.get(guild.id, "defaultautoplay") ? "Activado" : "Desactivado"}\`__!**`)
        ],
      })
    } catch (e) {
